...
export default function LoginLayout({
    ...
    return (
        <div className="flex min-h-svh">
            ...
            {/* Right — promo panel */}
            <div className="relative hidden overflow-hidden bg-gray-50 lg:flex lg:w-1/2 lg:flex-col lg:items-center lg:justify-center lg:border-l lg:border-gray-200 lg:p-12 xl:p-16">
                <div className="absolute top-0 right-0 h-64 w-64 rounded-full bg-[#1565C0]/5 blur-3xl" />
                <div className="absolute bottom-0 left-0 h-48 w-48 rounded-full bg-gray-200/60 blur-3xl" />
                ...
                <div className="relative z-10 flex w-full max-w-md flex-col">
                    ...
                    <div className="mt-10">
                        ...
                        <h2 className="mt-2 text-2xl leading-snug font-bold tracking-tight text-gray-900 xl:text-3xl">
                            Buy. Sell. Finance.
                            <br />
                            All in One Place.
                        </h2>
                    ...
                    <ul className="mt-8 space-y-3.5 border-t border-gray-200 pt-8">
                        {[
